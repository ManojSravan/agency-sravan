  ...
  return (
    <section id="work" className="py-24 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16">
          <p className="text-sm font-semibold tracking-widest uppercase text-accent mb-4">04 / Case Studies</p>
          <h2 className="text-5xl md:text-6xl font-bold tracking-tight">Our best work</h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {studies.map((study) => (
            <div
              key={study.title}
              className="group relative overflow-hidden rounded-lg border border-border hover:border-accent transition-all"
            >
              <div className="aspect-video  from-accent/20 to-primary/20 flex items-center justify-center">
                <img
                  src={study.mockup || ''}
                  alt={study.title}
              ...
              <div className="p-6 bg-background">
                <p className="text-xs font-semibold tracking-widest uppercase text-accent mb-2">{study.category}</p>
                ...
                <p className="text-sm font-semibold text-accent">{study.metrics}</p>
              </div>
            </div>
          ))}
        </div>
